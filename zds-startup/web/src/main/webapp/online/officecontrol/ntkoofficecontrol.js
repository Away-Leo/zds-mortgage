...
document.write('<param name="ProductCaption" value="重庆正大华日软件有限公司某某测试用户"> ');
document.write('<param name="ProductKey" value="BC124A3B10E154D9997F13F6F2176B86D16443A6">');
	...
	document.write('<SPAN STYLE="color:red">不能装载文档控件。请点击<a href="../../online/officecontrol/NtkoCrossBrowserSetup.rar" download="NtkoCrossBrowserSetup">安装组件</a></SPAN>   ');
...
document.write('_ProductCaption="重庆正大华日软件有限公司某某测试用户" ');
document.write('_ProductKey="BC124A3B10E154D9997F13F6F2176B86D16443A6"');
		...
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="../../online/officecontrol/ntkoplugins.xpi">安装组1件</a></SPAN>   ');
		document.write('</object>   ');
...
document.write('_ProductKey="BC124A3B10E154D9997F13F6F2176B86D16443A6"');
		...
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件。请点击<a href="../../online/officecontrol/ntkoplugins.crx">安装组件</a></SPAN>   ');
		document.write('</object>');
	}else if (Sys.opera){
