 ...
 * 
 * 版权所有：重庆正大华日软件有限公司
 * @Title: ConCaseContractSupplementVO.java 
 * @ClassName: ConCaseContractSupplementVO 
 * @Description: 合同信息补充
 * @author wangnengduo
 * @date 2017年3月2日 下午4:59:16 
 * @version V1.0
*/
public class ConCaseContractSupplementVo   extends BaseVo<ConCaseContractSupplement>{
	/**
	 * id
	 */
	private String id;
	...
	public ConCaseContractSupplementVo() {
		super();
	}

	
	public ConCaseContractSupplementVo(ConCaseContractSupplement ConCaseContractSupplement, String[] args, String[] simpleArgs) {
		super(ConCaseContractSupplement, args, simpleArgs);
	}
	
	public ConCaseContractSupplement toPo() {
		ConCaseContractSupplement conCaseContractSupplement = new ConCaseContractSupplement();
		return (ConCaseContractSupplement)super.toPo(this, conCaseContractSupplement);
	}

	public ConCaseContractSupplementVo(ConCaseContractSupplement conCaseContractSupplement) {
		super(conCaseContractSupplement);
	}
}
