 ...
 * 
 * 版权所有：重庆正大华日软件有限公司
 * @Title: ConCaseContractSupplement2VO.java 
 * @ClassName: ConCaseContractSupplement2VO 
 * @Description: 合同信息补充2
 * @author wangnengduo
 * @date 2017年3月2日 下午5:05:19 
 * @version V1.0
 */
public class ConCaseContractSupplement2Vo   extends BaseVo<ConCaseContractSupplement2>{
	...
	public ConCaseContractSupplement2Vo() {
		super();
	}

	
	public ConCaseContractSupplement2Vo(ConCaseContractSupplement2 ConCaseContractSupplement2, String[] args, String[] simpleArgs) {
		super(ConCaseContractSupplement2, args, simpleArgs);
	}
	
	public ConCaseContractSupplement2 toPo() {
		ConCaseContractSupplement2 conCaseContractSupplement2 = new ConCaseContractSupplement2();
		return (ConCaseContractSupplement2)super.toPo(this, conCaseContractSupplement2);
	}

	public ConCaseContractSupplement2Vo(ConCaseContractSupplement2 conCaseContractSupplement2) {
		super(conCaseContractSupplement2);
	}
}
