 ...
 * @version V1.0
 */
public class FollowInfoVo extends BaseVo<FollowInfo> {


	private static final long serialVersionUID = 8503850440809770718L;
	/**
     * 案件Id
     */
    @Column(length = 32)
	...
	public FollowInfoVo(FollowInfo followInfo){
		super(followInfo);
	}
