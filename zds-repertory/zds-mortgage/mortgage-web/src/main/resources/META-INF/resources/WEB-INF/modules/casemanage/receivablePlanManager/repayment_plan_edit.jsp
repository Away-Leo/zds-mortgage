...
<body>
<div class="save">
	<button id="saveReceivable" class="btn-blue mr10" >保存</button>
	<button id="submitReceivable" class="btn-blue mr10" >提交</button>
</div>
...
<script type="text/javascript">
	seajs.use(['jquery', 'zd/jquery.zds.page.callback', 'zd/jquery.zds.loading', 'zd/jquery.zds.combobox', 'zd/jquery.zds.message', 'zd/jquery.zds.form', 'datepicker', 'zd/jquery.zds.table', 'zd/jquery.zds.seleter'],
	  	function ($, CALLBACK,Loading, ZUI_MESSAGE_CLIENT) {
		
		//还款计划加载
		var receivableEditUrl = '<z:ukey key="com.cnfh.rms.casemanage.receivablePlan.receivableAfterPlan" context="admin"/>&caseApplyId=${caseApplyVo.id }';
		$('#receivableEdit').load(receivableEditUrl);
		
		//查看还款计划
		$("#searchReceivablePlan").click(function(){
			var receivablePlanUrl = '<z:ukey key="com.cnfh.rms.casemanage.receivablePlan.viewReceivablePlan" context="admin"/>&caseApplyId=${caseApplyVo.id }';
		...
		//提交还款计划信息
		$('#submitReceivable').click(function(){
			saveData(true);
		});
