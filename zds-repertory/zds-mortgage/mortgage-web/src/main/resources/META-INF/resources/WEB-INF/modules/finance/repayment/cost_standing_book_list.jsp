		...
		<div id="search" class="p5">
			<form id="search_from" class="zui-form form-search" method="post" >
				...
				<dl class="form-item">
					...
					<dd class="detail">
						<label> 
							<input class="zui-combobox" type="hidden" name="mca|stage|E|S" id='caseApplyStatus'
...
<!-- 	                <span class="word">_</span> -->
	...
	<div class="page-box">
		<div class="p10">
			<div id="caseApplyTable" class="zui-datagrid" zdata-options='{"url":"<z:ukey key="com.zdsoft.finance.costStanding.getCaseApplyAndFeeList" context="admin"/>","singleSelect":true,"pagination":true,"idField":"id","tableCls":"table-index"}'>
				<table>
        			<tr>
            			...
            			<th data-options="field:RECEIVEDAMOUNT"  >已收费用(元)</th>
            			<th data-options="field:PAIDAMOUNT"  >已付金额(元)</th>
            			<th data-options="field:BALANCEAMOUNT"   >结余(元)</th>
...
seajs.use(['jquery','zd/jquery.zds.page.callback','zd/tools','zd/jquery.zds.form','zd/jquery.zds.message','zd/jquery.zds.table','zd/jquery.zds.combobox'], function($, CALLBACK,ZTools) {
	...
	CALLBACK.operation=function(rowData,index){
		return '<a href="javaScript:void(0)" onclick="receipt"><button class="btn-blue">详情</button></a>';
	};
	...
	CALLBACK.receipt=function(index,rowData){
		var	url = '<z:ukey key="com.zdsoft.finance.finance.costStanding.view" context="admin"/>&caseApplyId='+rowData.ID;
