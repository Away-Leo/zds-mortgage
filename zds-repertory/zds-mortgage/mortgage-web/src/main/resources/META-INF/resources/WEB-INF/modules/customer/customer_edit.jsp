	...
	<div>
		<div class="page-box">
			<div class="p10">
					...
					<div class="page-box">
						...
						<dl class="form-item">
							...
							<dd class="detail">
									...
									id="clientNm" name="clientNm" value="${latestCustomerVo.clientNm }" >
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
									...
									id="formerNm" name="formerNm" value="${latestCustomerVo.formerNm }" >
							</dd>
						</dl>
						<dl class="form-item">
			                ...
			                <dd class="detail">
			                    <input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-15]" id="credentiaType" type="hidden" name="credentiaType" value=""
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=060600"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.credentiaType }" >
			                </dd>
			            </dl>
						<dl class="form-item">
							...
							<dd class="detail">
									...
									id="credentialNo" name="credentialNo" value="${latestCustomerVo.credentialNo }">
							</dd>
						</dl>
						<dl class="form-item">
							<dt class="title"><b class="c-red mr5">*</b>出生日期：</dt>
							<dd class="detail">
									<input type="text" class="zui-date zui-validatebox" validate-type="Require" id="birthday" value="${latestCustomerVo.birthday }" onclick="WdatePicker({realDateFmt:'yyyyMMdd',vel:'changeBirthday'})">
		                            <input type="hidden" id="changeBirthday" name="birthday" value="${latestCustomerVo.birthday }"/>
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=3030"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.gender }">
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=x030300"
			                           data-valuefield="fullcode" data-textfield="name" data-callback="onselect" data-defaultvalue="${latestCustomerVo.marital }">
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=c10100"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.careerType }">
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
									...
									id="annualIncome" name="annualIncome" value="${latestCustomerVo.annualIncome }" >
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=e030300"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.degree }">
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
									...
									id="email" name="email" value="${latestCustomerVo.email }" >
							</dd>
						</dl>
						<dl class="form-item">
							...
							<dd class="detail">
									<input class="zui-combobox zui-validatebox" validate-type="Length[0-15]" id="liveAge" type="hidden" name="liveAge" value=""
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=y00100"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.liveAge }">
							</dd>
						</dl>
						<br>
						<dl class="form-item">
							...
							<%-- <dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=2222"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.liveProvince }">
                            </dd>
                            <dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=1919"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.liveCity }">
                             </dd>
                            <dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=1919"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.liveDistrict }">
                             </dd> --%>
                             <dd class="detail">
                            ...
                            <dd class="detail">
									...
									id="liveAddress" name="liveAddress" value="${latestCustomerVo.liveAddress }" >
							</dd>
						</dl>
						<br>
						<dl class="form-item">
							...
							<%-- <dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=2222"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.domicileProvince }">
                            </dd>
                            <dd class="detail">
                               		<input class="zui-combobox zui-validatebox" validate-type="Length[0-15]" id="domicileCity" type="hidden" name="domicileCity" value=""
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=1919"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.domicileCity }">
                           </dd>
                           <dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=1919"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${latestCustomerVo.domicileDistrict }">
                          </dd> --%>
                          <dd class="detail">
                          ...
                          <dd class="detail">
									...
									id="domicileAddress" name="domicileAddress" value="${latestCustomerVo.domicileAddress }" >
							</dd>
							<dd class="detail">
				...
				<form id="marital_form" class="zui-form " method="post" enctype="multipart/form-data" <c:if test="${latestCustomerVo.marital == 'x0303002' || latestCustomerVo.marital == 'x0303003' || latestCustomerVo.marital == 'x0303004' || latestCustomerVo.marital == 'x0303005'}">style="display:inline"</c:if><c:if test="${latestCustomerVo.marital != 'x0303002' && latestCustomerVo.marital != 'x0303003' && latestCustomerVo.marital != 'x0303004' && latestCustomerVo.marital != 'x0303005'}">style="display:none"</c:if>>
					...
					<div class="page-box">
						...
						<dl class="form-item">
							...
							<dd class="detail">
									<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
									id="maritalformerNm" name="formerNm" value="${maritalCustomerVo.formerNm }" >
							</dd>
						</dl>
						<dl class="form-item">
			                <dt class="title"><b class="c-red mr5">*</b>证件类型:</dt>
			                <dd class="detail">
			                    <input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-15]" id="maritalcredentiaType" type="hidden" name="credentiaType" value=""
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=060600"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${maritalCustomerVo.credentiaType }">
			                </dd>
			            </dl>
						<dl class="form-item">
							<dt class="title"><b class="c-red mr5">*</b>证件号码：</dt>
							<dd class="detail">
									<input class="zui-input zui-validatebox" validate-type="Require,Length[1-18]" 
									id="maritalcredentialNo" name="credentialNo" onblur="checkMaritalCredentialNo()" value="${maritalCustomerVo.credentialNo }">
							</dd>
						</dl>
						<dl class="form-item">
							<dt class="title"><b class="c-red mr5">*</b>职业类型：</dt>
							<dd class="detail">
			                          ...
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=g050500"
			                           data-valuefield="fullcode" data-textfield="name" data-defaultvalue="${maritalCustomerVo.careerType }">
							</dd>
						</dl>
						<dl class="form-item">
							<dt class="title">邮箱地址：</dt>
							<dd class="detail">
									<input class="zui-input zui-validatebox" validate-type="Length[0-32]" 
									id="maritalemail" name="email" value="${maritalCustomerVo.email }" >
							</dd>
						</dl>
					</div>					
		        </form>
		            <div class="page-box">
						...
						<div class="p10">
					        <div id="tb-contact" class="zui-datagrid" zdata-options='{"url":"<z:ukey key="com.zdsoft.finance.contact.findByClientId" context="admin"/>&jsoncallback=?&clientId|E|S=${latestCustomerVo.id}","singleSelect":true,"pagination":true,"idField":"id","tableCls":"table-index","toolbar":"#contact-function"}'>
							    <table>
							        <thead>
							        <tr>
					...
					<div class="page-box">
						...
						<div class="p10">
					        <div id="tb-unit" class="zui-datagrid" zdata-options='{"url":"<z:ukey key="com.zdsoft.finance.workUnits.findByClientId" context="admin"/>&jsoncallback=?&clientId|E|S=${latestCustomerVo.id}","singleSelect":true,"pagination":true,"idField":"id","tableCls":"table-index","toolbar":"#unit-function"}'>
							    <table>
							        <thead>
							        <tr>
						...
						<div class="p10">
					        <form id="contact_form" class="zui-form " method="post" enctype="multipart/form-data">
								...
								<dl class="form-item">
									...
									<dd class="detail">
											<input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-15]" id="relationshipType" type="hidden" name="relationshipType">
									</dd>
								</dl>
								<dl class="form-item">
									<dt class="title"><b class="c-red mr5">*</b>联系类型：</dt>
									<dd class="detail">
											<input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-15]" id="contactType" type="hidden" name="contactType">
									</dd>
								</dl>
								<dl class="form-item">
						...
						<div class="p10">
					        <form id="unit_form" class="zui-form " method="post" enctype="multipart/form-data">
								...
								<dl class="form-item">
									<dt class="title"><b class="c-red mr5">*</b>关系：</dt>
									<dd class="detail">
											<input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-15]" id="relationshipTypes" name="relationshipType">
									</dd>
								</dl>
								<dl class="form-item">
			...
			CALLBACK.contactAdd = function(index, row){
		  		...
		  		if(id==null || id==""){
		  			...
		  			$("#contactName").ZCombobox({
		  		         ...
		  		         emptyValue:true,
		  		         multiple:false,
		  		         url:"<z:ukey key='com.zdsoft.finance.customer.findClientNameByClientId' context='admin'/>&jsoncallback=?&clientId=${latestCustomerVo.id }"
		  		  	});
