		...
		<form id="credit_entrust_form" class="zui-form " method="post"
			...
			<div class="page-box">
				...
				<dl class="form-item">
					...
					<dd class="detail">
						<label> <input class="zui-input zui-disable zui-validatebox"  validate-type="Require,Digital[18-12]" value="${creditEntrustPrincipalVo.principalAmount }"
				...
				<dl class="form-item">
					...
					<dd class="detail">
						 <label>
                            <input type="text" id="addDateLocal" value="${creditEntrustPrincipalVo.addDate }" class="zui-input zui-disabled strToDate  zui-validatebox" readonly="readonly"  validate-type="Require" >
                            <input type="hidden" name="addDate" value="${creditEntrustPrincipalVo.addDate }" id="addDate" />
                         </label>
					</dd>
				</dl>
				<dl class="form-item">
					<dt class="title"><b class="c-red mr5">*</b>信托保障基金比率(%)：</dt>
					<dd class="detail">
				...
				<dl class="form-item">
					...
					<dd class="detail">
						 <label>
                            <input type="text" id="actualDateLocal" class="zui-input strToDate zui-validatebox" validate-type="Require" value="${creditEntrustPrincipalVo.actualDate }" onclick="WdatePicker({realDateFmt:'yyyyMMdd',vel:'actualDate'})">
