...
<div id="capitalistDialogDiv">
	<div id="InfoDialog" >
	    <form id="contactForm" class="zui-form mt15" >
	    	...
	    	<input type="hidden" name="orgCantractApplyId" id="orgCantractApplyId" value="${agencyContractId }" >
	    	<dl class="form-item">
	        ...
	        <dl class="form-item">
	            ...
	            <dd class="detail">
	                <label>
	                	<input class="zui-input zui-validatebox" id="recontractName" name="contractName" validate-type="Require" value="${vo.contractName }" >
	                </label>
	            </dd>
	        </dl>
	        <dl class="form-item">
	       	...
	       	<dl class="form-item block">
				...
				<dd class="detail">
					...
					<div>
						<span id="importProcessUploadStatus" class="f12" style="margin-left: 10px;">
	        ...
	        <dl class="form-item">
				...
				<dd class="detail">
					<textarea class="zui-area zui-validatebox" validate-type="Length[0-3000]" id="remark" name="remark" placeholder="最多可以输入3000个字符"  validate-type="Require" >${vo.remark}</textarea>
				</dd>
			</dl>
	     </form>
		</div>
        ...
        [
            {
                ...
                handler: function () {
                	...
                	var contactForm = $('#contactForm').serialize();
                        $.ajax({
                            type: 'post',
                            url: '<z:ukey key="com.zdsoft.finance.contract.saveSubAgencyContract" context="admin"/>',
                            data: contactForm,
                            dataType: 'json',
                            success: function (data) {
                                if (data.resultStatus == 0) {
                                	...
                                	$('#tb-plan').ZTable("reload",{agencyContractIdBack:$("#orgCantractApplyId").val()});
