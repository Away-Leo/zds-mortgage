                ...
                <table class="table-detail">
                    <tr>
                        ...
                        <td class="pct20">
                            <dl class="form-item">
                                <dd class="detail">
                                    <input class="zui-combobox zui-validatebox zui-disabled" id="applyType" type="hidden"
                    ...
                    <tr>
                        ...
                        <td class="pct20">
                            <dl class="form-item">
                                <dd class="detail">
                                    <label>
                                        <input class="zui-input zui-validatebox" id="trackingNoSend" type="text"
                                               name="trackingNoSend"
                                               validate-type="Require"
                                               value="${contractSeal.trackingNoSend}"/>
                                    </label>
                                </dd>
                            </dl>
    ...
    seajs.use(['jquery', 'zd/jquery.zds.page.callback', 'zd/tools', 'zd/jquery.zds.loading', 'zd/jquery.zds.combobox', 'zd/jquery.zds.table',
        ...
        ZDS_WORKFLOW_CLIENT.saveFunction = function (datas) {
            ...
            if (sealFormValidate) {
                ...
                Loading.show();
                $.post('<z:ukey key="com.zdsoft.finance.contract.conCaseContractSeal.saveSealBack" context="admin"/>',
