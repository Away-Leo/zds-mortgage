...
<script type="text/javascript">
	seajs.use(['jquery','zd/jquery.zds.page.callback','zd/jquery.zds.loading','zd/jquery.zds.form','zd/jquery.zds.message','zd/jquery.zds.dialog','zd/jquery.zds.combobox','zd/jquery.zds.table','zd/jquery.zds.seleter'], 
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (data.resultStatus == 0) {
						...
						if(data.optional.isRefuse){
							$.ZMessage.error("拒绝弹窗", "您暂时不符合我司贷款要求！", function () {
								if(status){
									setTimeout(function(){
