...
<script type="text/javascript">
	    seajs.use(
	    	...
	    	var url_edit_requestFunds_page='<z:ukey key="com.zdsoft.finance.requestCommission.requestCommissionEditPage" context="admin"/>';
	    	...
	    	$('#zd-table').ZTable({
                  ...
                  toolbar : [
                	  {
                          id: 'btncut3', text: '支佣请款', iconCls: 'icon-btn08', buttonCls: 'btn-blue',
                          handler: function () {
                              ...
                              ZDS_MESSAGE_CLIENT.openMenuLink('case_requestFuxnds_apply_tab', "支佣请款",url_edit_requestFunds_page+"&caseApplyId="+caseApplyIds+"&reqType=2");
                          }
                      }
                  ],
                  columns:[[
