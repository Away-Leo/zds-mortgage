		...
		<table class="table-detail">
			<tr>
				...
				<td class="pct20">
					<dl class="form-item form-auto">
						<dd class="detail">
							<label> <input type="text" class="zui-input zui-validatebox" value="${housePropertyVo.communityName }" name="housePropertyVo.communityName" validate-type="Require"/>
							</label>
						</dd>
					</dl>
				</td>
				...
				<td class="pct20">
					<dl class="form-item form-auto">
						<dd class="detail">
							<label> <input type="text" class="zui-input zui-validatebox" value="${housePropertyVo.placeFloor }" name="housePropertyVo.placeFloor" validate-type="Require,Integer"/><front style="font-size: 14px;">层</front>
							</label>
						</dd>
					</dl>
				</td>
				...
				<td class="pct30">
					<dl class="form-item form-auto">
						<dd class="detail">
							<label> <input type="text" class="zui-input zui-validatebox" value="${housePropertyVo.sumFloor }" name="housePropertyVo.sumFloor" validate-type="Require,Integer"/><front style="font-size: 14px;">层</front>
							</label>
						</dd>
					</dl>
				</td>
			...
			<tr>
				...
				<td>
					<dl class="form-item form-auto">
						<dd class="detail">
							<label> <input type="text" class="zui-input zui-validatebox" value="${housePropertyVo.area }" name="housePropertyVo.area" validate-type="Require,Amount"/><front style="font-size: 14px;">㎡</front>
							</label>
						</dd>
					</dl>
				</td>
			...
			<tr>
				...
				<td>
					<dl class="form-item form-auto">
						<dd class="detail">
							<label> <input type="text" class="zui-input" value="${housePropertyVo.floorAge }" name="housePropertyVo.floorAge" validate-type="Integer"/><front style="font-size: 14px;">年</front>
							</label>
						</dd>
					</dl>
				</td>
