			...
			<div class="page-box">
		        ...
		        <div class="p5">
		            <table class="table-detail">
		                <tr>
		                    <td class="td-title pct10">操作类型</td>
		                    <td class="pct20">${spareCapitalVo.operationTypeName }</td>
		                    <td class="td-title pct10">请款金额</td>
		                    <td class="pct20">${spareCapitalVo.applyAmount }</td>
		                    <td class="td-title pct10"></td>
		                    <td class="pct20"></td>
		                </tr>
		                 <tr>
		                    <td class="td-title">备注</td>
		                    <td colspan="5">${spareCapitalVo.applyRemark }</td>
		                </tr>
		            </table>
	            </div>
		        ...
		        <div class="p5">
		            <table class="table-detail">
		                <tr>
		                    <td class="td-title pct10">实际到账金额</td>
		                    <td class="pct20">${spareCapitalVo.actualAmount }</td>
		                    <td class="td-title pct10">实际到账日期</td>
		                    <td class="pct20">${spareCapitalVo.actualArrivalDate }</td>
		                    <td class="td-title pct10"></td>
		                    <td class="pct20"></td>
		                </tr>
		                 <tr>
		                    <td class="td-title">备注</td>
		                    <td colspan="5">${spareCapitalVo.actualRemark }</td>
		                </tr>
		            </table>
	            </div>
	            <div class="page-box">
