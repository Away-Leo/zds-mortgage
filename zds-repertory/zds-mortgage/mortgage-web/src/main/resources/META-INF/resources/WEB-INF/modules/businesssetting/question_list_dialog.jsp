    ...
    <div id="dialog">
        <form id="addQuestionForm" class="zui-form mt15" action="javascript:void(0);"
            ...
            <dl class="form-item">
	             ...
	             <dd class="detail">
	                <label> 
						<input class="zui-input zui-validatebox" style="width: 504px" validate-type="Require,Length[1-60]" name="title" value="${question.title }">
					</label>
	             </dd>
	        </dl>
	        <br/>
            <dl class="form-item">
	             ...
	             <dd class="detail">
	                 <input class="zui-combobox zui-validatebox" type="hidden" validate-type="Require" value="${question.typeCd }" data-callback="showParam" id="typeCdValue"
	             	          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=YWDM00147"
            ...
            <dl class="form-item" id="showParam">
	             ...
	             <dd class="detail">
					...
					<input class="zui-combobox zui-validatebox" data-multiple="true" type="hidden" validate-type="Require" value="${question.paramCd }" id="paramCdValue"
	             	          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=YWDM00123"
