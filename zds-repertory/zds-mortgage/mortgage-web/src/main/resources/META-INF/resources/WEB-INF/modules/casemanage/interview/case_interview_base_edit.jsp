...
seajs.use(['jquery',  'zd/switch','zd/jquery.zds.page.callback','zd/jquery.zds.loading', 
	...
	CALLBACK.interview=function(){
    	//面签信息
    	//编辑页面
    	var url='<z:ukey key="com.cnfh.rms.casemanage.interview.interviewEdit" context="admin"/>&id=${caseApplyId}';
    	if(interview){
    ...
    CALLBACK.questionnaire=function(){
    	var url='<z:ukey key="com.zdsoft.finance.question.questionnairePage" context="admin"/>&caseApplyId=${caseApplyId}&sceneTypeCode=YWDM0010203';
    	if(questionnaire){
        	$('#showQuestionnaire').load(url,function(){
        		questionnaire=false;
        		$("#questionnaire_btn").show();
        	}); 
    	}
    }
