			...
			<div class="p5">
				<form action="#" id="searchForm" class="zui-form form-search" method="post"
					...
					<dl class="form-item">
						...
						<dd class="detail">
							<label>
								<input type="text" class="zui-input" name="empName|LK|S"
									id="empName" />
							</label>
						</dd>
					</dl>
					...
					<table >
						<thead>
							<tr>
								...
								<th data-options="field:name,width:20%">费用名称</th>
    ...
    <div id="testForm" class="mt20">
        <form id="dialogForm" class="zui-form" >
            ...
            <dl class="form-item">
                ...
                <dd class="detail">
                	<label>
                		<input type="text" class="zui-input zui-validatebox" id="form_name"   validate-type="Require,Length[1-25]" validate-false="费用名称不能为空"/>
                	</label>
                </dd>
            </dl>
            <dl class="form-item">
