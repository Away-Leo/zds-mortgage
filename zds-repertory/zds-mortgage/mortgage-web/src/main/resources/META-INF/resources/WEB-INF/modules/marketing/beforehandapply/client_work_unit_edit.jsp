	     ...
	     <form id="workUnit_form" class="zui-form" method="post" enctype="multipart/form-data">
        	...
        	<dl class="form-item">
             ...
             <dd class="detail">
                       ...
                       data-valuefield="fullcode" data-textfield="name" validate-type="Require"  name="industryType" id="industryType" data-toggle="combobox" data-callback="industryChange">
             </dd>
        	</dl>  
        	<dl class="form-item">
             ...
             <dd class="detail">
               		<input class="zui-combobox zui-validatebox" type="hidden"
                       data-valuefield="fullcode" data-textfield="name" validate-type="Require"  name="industry" id="industry" data-toggle="combobox">
             </dd>
        	</dl>
        	<dl class="form-item">
        	...
        	<dl class="form-item">
             ...
             <dd class="detail">
               <label> 
               	<input type="text" class="zui-input zui-validatebox" name="workYears" id="workYears" validate-type="Require,Integer"/><front style="font-size: 14px;">年</front>
               </label> 
             </dd>
        	</dl>
        	<dl class="form-item">
	...
	<script type="text/javascript">
		seajs.use(['jquery','zd/jquery.zds.page.callback','zd/jquery.zds.dialog','zd/jquery.zds.table','zd/jquery.zds.address'], 
		       ...
		       [
		           {
		               ...
		               buttonCls: 'btn-blue',
		               handler: function () {
		            	   var isValid = $.ZUI.validateForm($('#workUnitEditDiv'));
		            	   if (isValid) {
		            		   var isAdd = false;
		            		   ...
		            		   if (!isAdd) {//编辑
		                           ...
		                           arr[1]={
		                                   ...
		                                   "industryTypeNm": $("#industryType").ZCombobox("getText"),
		                                   "industry": $("#industry").ZCombobox("getValue"),
		                                   "industryNm": $("#industry").ZCombobox("getText"),
		                                   "workUnitNature": $("#workUnitNature").ZCombobox("getValue"),
		                                   "workUnitNatureNm": $("#workUnitNature").ZCombobox("getText"),
		                                   "position": $("#position").ZCombobox("getValue"),
		                                   "positionNm": $("#position").ZCombobox("getText"),
		                                   "workYears": $("#workYears").val(),
		                                   "phoneNumber": $("#workPhoneNumber").val(),
		                                   "workUnitAddressName": $("#address_workUnit_text").val(),
			...
			$('#workUnitList').ZTable({
		       ...
		       columns:[[
					...
					{field : 'id',title : '操作', align : 'center',formatter:function(r,v){
						return '<a href="javaScript:void(0)" onclick="editWorkUnitHandle"><button class="btn-blue" type="button">编辑</button></a>&nbsp;&nbsp;<a href="javaScript:void(0)" onclick="deleteWorkUnitHandle"><button class="btn-blue" type="button" >删除</button></a>';
					}}
			] ],
			...
			CALLBACK.deleteWorkUnitHandle=function(index, rowData){
				//模拟点击选中事件
				$($('#workUnitList .datagrid-body').find("tr")[0]).trigger("click");
