                    ...
                    <table class="table-detail">
                        <tr>
                            ...
                            <td class="pct20" colspan="3">
                                <dd class="detail">
                                    <label>
                                        <input style="width:100%" class="zui-input zui-validatebox"
                                               validate-type="Require,Length[0-108]" name="applyTitle"
                                               value="${vo.applyTitle}">
                                    </label>
                                </dd>
                            </td>
                ...
                <div class="p5">
                    <table class="table-detail">
                        <tr>
                            ...
                            <td colspan="7">
                                <label>
                                    <textarea class="zui-area zui-validatebox row-width"  placeholder="最多可以输入200个字符" validate-type="Require,Length[0-200]" id="applyReason" name="applyReason"
...
<div id="contactsDialog" style="display: none">
    <script type="text/javascript">
        seajs.use(['jquery', 'zd/jquery.zds.page.callback', 'zd/jquery.zds.loading', 'zd/jquery.zds.combobox',
