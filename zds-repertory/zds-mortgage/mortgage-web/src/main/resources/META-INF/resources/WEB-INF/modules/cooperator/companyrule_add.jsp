								...
								<thead class="datagrid-header">
							  	...
							  	<tbody class="datagrid-body">
									    ...
									    <td>
											...
											id="evaluateCompanyOne" name="evaluateCompanyOne">
											</dd>
											</dl>
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="outProportionOne" name="outProportionOne" >
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="calculateRuleOne" name="calculateRuleOne" >
										</td>
									  </tr>
									  <tr>
									    <td>
											...
											id="evaluateCompanyTwo" name="evaluateCompanyTwo">
											</dd>
											</dl>
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="outProportionTwo" name="outProportionTwo" >
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="calculateRuleTwo" name="calculateRuleTwo" >
										</td>
									  </tr>
									  <tr>
									    <td>
										    ...
										    <dd class="detail">
									    	<input class="zui-combobox" type="hidden"
											id="evaluateCompanyThree" name="evaluateCompanyThree">
											</dd>
											</dl>
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="outProportionThree" name="outProportionThree" >
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="calculateRuleThree" name="calculateRuleThree" >
										</td>
									  </tr>
									  <tr>
									    <td>
										    ...
										    <dd class="detail">
									    	<input class="zui-combobox" type="hidden"
											id="evaluateCompanyFour" name="evaluateCompanyFour">
											</dd>
											</dl>
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="outProportionFour" name="outProportionFour" >
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="calculateRuleFour" name="calculateRuleFour" >
										</td>
									  </tr>
									  <tr>
									    <td>
										    ...
										    <dd class="detail">
									    	<input class="zui-combobox" type="hidden"
											id="evaluateCompanyFive" name="evaluateCompanyFive">
											</dd>
											</dl>
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="outProportionFive" name="outProportionFive" >
										</td>
									    <td>
									    	<input class="zui-input zui-validatebox" validate-type="Length[0-64]" 
											id="calculateRuleFive" name="calculateRuleFive" >
										</td>
									  </tr>
							  	</tbody>
							</table>
	                        ...
	                        success: function (data) {
	                            if (data.resultStatus == 0) {
	                            	$.ZMessage.warning("提示", "保存成功", function () {
	                            		$('#id').val(data.optional.newevaluateCompanyRuleVo.id);
	                              	 });
	                            }else{
