...
<form action="" id="searchStatusForm" class="zui-form">
	...
	<div class="page-box">
		...
		<div class="p5">
		<input type="hidden" value="${housePropertyVo.caseApplyId }" name="caseApply.id">
			<table class="table-detail" id="propertyStatusTable">
				<tr>
					<td class="td-title pct10"><b class="c-red mr5">*</b>查册状态</td>
					<td class="pct20">
						<dd class="detail">
							<input class="zui-checkbox " id="searchStatusBtn" name="searchStatus"
				...
				<tr style="display:none">
					...
					<td>
						<dd class="detail">
							<input class="zui-checkbox " name="isSearched" value="${searchVo.isSearched }"
				...
				<tr style="display:none">
					...
					<td>
						<dd class="detail">
							<input class="zui-checkbox " id="isSearchHistoryBtn" name="isSearchHistory"
				...
				<tr style="display:none">
					...
					<td>
						<dd class="detail">
							<input class="zui-checkbox " id="isMortgageHistoryBtn" 
...
<script type="text/javascript">
	seajs.use(['jquery','zd/jquery.zds.form'], 
	function($, CALLBACK) {
		$.ZUI.init();
