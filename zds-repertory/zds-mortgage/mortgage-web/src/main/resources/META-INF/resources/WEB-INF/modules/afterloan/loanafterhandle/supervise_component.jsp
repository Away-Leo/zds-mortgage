				     ...
				     <table class="table-detail">  
				           ...
				           <tr>
				               ...
				               <td class="pct20">
				                   <dl class="form-item form-auto">      
				                       <dd class="detail f12">
				                       <label><input class="zui-date zui-validatebox" type="text" id="processingDateStr"  value="" onclick="WdatePicker({realDateFmt:'yyyyMMdd',vel:'processingDate'})" validate-type="Require"  readonly />
				              ...
				              <td class="td-title pct10"><b class="c-red mr5">*</b>督办说明 </td>            
				               <td colspan="5">         
				                   <dl class="form-item form-auto">   
				                          ...
				                          <textarea class="zui-area zui-validatebox row-width" name="remark" validate-type="Require,Length[0-3000]"
