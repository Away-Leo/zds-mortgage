            ...
            <form id="client_form" class="zui-form " method="post" enctype="multipart/form-data">
                ...
                <div class="page-box">
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <input class="zui-combobox zui-validatebox" validate-type="Require,Length[1-20]"
                                   id="enterpriseType" type="hidden" name="enterpriseType" value=""
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-20]"
                                   id="companyType" type="hidden" name="companyType" value=""
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-20]"
                                   id="companyBelong" type="hidden" name="companyBelong" value=""
                                   data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=YWDM00104"
                                   data-valuefield="fullcode" data-textfield="name" data-width="94px" data-callback="changeCode">
                        </dd>
                        <dd class="detail" id="ddbelongCode1">
                            <input class="zui-input width2 " id="belongCode1" value="">
                        </dd>
                        <dd class="detail" id="ddbelongCode2">
                              <input class="zui-input width2 "  id="belongCode2" value="">
                              <input type="hidden" id="companyBelongRelevanceCode" name="companyBelongRelevanceCode" value=""/>
                              <input type="hidden" id="companyBelongRelevanceName" name="companyBelongRelevanceName" value=""/>
                        </dd>
                    </dl>
                    <dl class="form-item">
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <input type="hidden" id="addProvince" name="addProvince" value=""/>
                            ...
                            <div id="selectAddress" data-code="">
                                <label>
                                    <input id="region" class="zui-input zui-validatebox" type="text" readonly="true"
                                           style="width: 190px;" validate-type=""/>
                                </label>
                            </div>
                        </dd>
                        <dd class="detail">
                ...
                <div class="page-box">
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <input type="text" class="zui-date zui-validatebox strToDate" readonly id="foundDate"
                                   onclick="WdatePicker({realDateFmt:'yyyyMMdd',vel:'changeFoundDate',maxDate:'${maxDate}'})">
                            <input type="hidden" id="changeFoundDate" name="foundDate"/>
                        </dd>
                    </dl>
                    <dl class="form-item">
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <label>
                                <input class="zui-input zui-validatebox" validate-type="Length[0-32],Number"
                                       id="taxNo" name="taxNo">
                            </label>
                        </dd>
                    </dl>
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <input class="zui-combotree zui-validatebox" validate-type="Length[0-20]" id="industry"
                                   type="hidden" name="industry" value=""
                    ...
                    <dl class="form-item">
                        ...
                        <dd class="detail">
                            <label>
                                <textarea class="zui-area zui-validatebox" validate-type="Length[0-512]" id="remark"
                                          name="remark" placeholder="最多可以输入512个字符"></textarea>
                            </label>
                        </dd>
                    </dl>
                </div>
