				...
				<form id="client_form" class="zui-form " method="post" enctype="multipart/form-data">
					...
					<div class="page-box">
							...
							<dd class="detail">
			                        <input class="zui-combobox zui-validatebox" validate-type="Require,Length[0-15]" id="contactCompanyBelong" type="hidden" name="contactCompanyBelong" value=""
			                          data-url="<z:res resource='public.simplecode.selector' isDefault='true'/>&jsoncallback=?&target=true&categoryCd=cb00100"
			                           data-valuefield="fullcode" data-textfield="name" data-width="94px" data-callback="setValue">
			                </dd>
			                <dd class="detail">
							<label>
						...
						<dl class="form-item">
							<dt class="title">地址：</dt>
                             <dd class="detail">
                             	<input type="hidden" id="detailedProvince" name="detailedProvince" value=""/>
	                            <input type="hidden" id="detailedCity" name="detailedCity" value=""/>
	                            <input type="hidden" id="detailedDistrict" name="detailedDistrict" value=""/>
                             	<div id="selectAddress" data-code="">
                             		<label>
			                            ...
			                            <!-- <input id="detailedCode" type="hidden" name="detailedCode" value=""/> -->
		                            </label>
		                        </div>
                             </dd>
                            <dd class="detail">
					...
					<div class="page-box">
						...
						<dl class="form-item">
							...
							<dd class="detail">
									<input type="text" class="zui-date zui-validatebox strToDate" readonly id="foundDate" onclick="WdatePicker({realDateFmt:'yyyyMMdd',vel:'changeFoundDate'})">
						...
						<dl class="form-item">
							...
							<dd class="detail">
							<label>
								<textarea class="zui-area zui-validatebox" validate-type="Length[0-3000]" id="remark" name="remark" placeholder="最多可以输入3000个字符"></textarea>
							</label>
							</dd>
						</dl>
					</div>					
