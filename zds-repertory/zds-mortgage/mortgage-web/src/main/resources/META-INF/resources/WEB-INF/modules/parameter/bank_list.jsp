			...
			<div class="p5">
				...
				<div class="zui-datagrid" id="zd-table"
					...
					<table >
						<thead>
							<tr>
								<th data-options="field:name,width:40%">银行名称</th>
								<th data-options="field:code,width:40%">银行代码</th>
    ...
    <div id="testForm"  class="mt20">
        <form id="dialogForm" class="zui-form">
            <dl class="form-item">
                ...
                <dd class="detail">
                    <label>
                    	<input id="bankId" style="display:none;">
                        <input type="text" class="zui-input zui-validatebox" id="form_name"  validate-type="Require,Length[1-25]" validate-false="银行名称不能为空"/>
                    </label>
                </dd>
            </dl>
            <dl class="form-item">
                ...
                <dd class="detail">
                	 <label>
                		<input type="text" class="zui-input zui-validatebox" id="form_code"  validate-type="Require,Length[1-25]" validate-false="银行代码不能为空"/>
                	 </label>
                </dd>
            </dl>
        </form>
